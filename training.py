...
from monai.networks.nets import DenseNet121, ViT, EfficientNetBN, DenseNet264
...
writer = SummaryWriter(log_dir="./logs/DenseNet/")
...
for epoch in range(EPOCHS):
    ...
    val_loss, val_auc = compute_metrics(
        y_true,
        y_prob
    )
...
Val logloss: {val_loss:.4f}
Val AUROC  : {val_auc:.4f}
"""
    )
